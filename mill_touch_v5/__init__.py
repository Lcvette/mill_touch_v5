...
"""Main entry point for mill_touch_v5.
...
Example:
    ...
    launch mill_touch_v5 by saying::

        $ mill_touch_v5 --ini=/path/to/config.ini [options ...]
...
def main(opts=None):
    ...
    if opts is None:
        ...
        opts = parse_opts(vcp_cmd='mill_touch_v5',
                          vcp_name='mill_touch_v5',
